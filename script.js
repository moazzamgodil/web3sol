...
window.addEventListener('load', async () => {
    ...
    //     if(window.localStorage.getItem('index') == contractsArray.indexOf(contractaddress)) {
    //         window.localStorage.setItem('index', contractsArray.length - 1);
    //     }
    ...
    //     window.localStorage.setItem('index', contractsArray.indexOf(_contractaddress));
